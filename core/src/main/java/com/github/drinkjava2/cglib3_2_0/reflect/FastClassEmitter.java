...
import com.github.drinkjava2.cglib3_2_0.core.Block;
...
class FastClassEmitter extends ClassEmitter {
    ...
    private static final Type FAST_CLASS =
      TypeUtils.parseType("com.github.drinkjava2.cglib3_2_0.reflect.FastClass");
    ...
    // TODO_ support constructor indices ("<init>")
    ...
    private static final int TOO_MANY_METHODS = 100; // TODO_
    ...
    private static void invokeSwitchHelper(final CodeEmitter e, List members, final int arg, final Type base) {
        ...
        e.process_switch(getIntRange(info.size()), new ProcessSwitchCallback() {
            public void processCase(int key, Label end) {
                ...
                // TODO_ change method lookup process so MethodInfo will already reference base
