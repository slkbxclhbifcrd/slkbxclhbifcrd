 ...
 */
package com.github.drinkjava2.cglib3_2_0.proxy;
...
import com.github.drinkjava2.cglib3_2_0.core.DuplicatesPredicate;
import com.github.drinkjava2.cglib3_2_0.core.EmitUtils;
import com.github.drinkjava2.cglib3_2_0.core.KeyFactory;
import com.github.drinkjava2.cglib3_2_0.core.Local;
import com.github.drinkjava2.cglib3_2_0.core.MethodInfo;
import com.github.drinkjava2.cglib3_2_0.core.MethodInfoTransformer;
import com.github.drinkjava2.cglib3_2_0.core.MethodWrapper;
import com.github.drinkjava2.cglib3_2_0.core.ObjectSwitchCallback;
import com.github.drinkjava2.cglib3_2_0.core.ProcessSwitchCallback;
...
import com.github.drinkjava2.cglib3_2_0.core.Transformer;
import com.github.drinkjava2.cglib3_2_0.core.TypeUtils;
import com.github.drinkjava2.cglib3_2_0.core.VisibilityPredicate;
...
public class Enhancer extends AbstractClassGenerator
{
    ...
    private static final Type FACTORY =
      TypeUtils.parseType("com.github.drinkjava2.cglib3_2_0.proxy.Factory");
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("com.github.drinkjava2.cglib3_2_0.proxy.Callback");
    ...
    private void emitNewInstanceCallback(ClassEmitter ce) {
        ...
        case 0:
            // TODO_ make sure Callback is null
            break;
        case 1:
            // for now just make a new array; TODO_ optimize
            e.push(1);
            e.newarray(CALLBACK);
            e.dup();
            e.push(0);
        ...
        CallbackGenerator.Context context = new CallbackGenerator.Context() {
            ...
            public void emitInvoke(CodeEmitter e, MethodInfo method) {
                ...
                if (bridgeTarget != null) {
                    // TODO_ this assumes that the target has wider or the same type
                    ...
                    // TODO_ It also isn't necessary to checkcast if the return is
