...
import com.github.drinkjava2.cglib3_2_0.transform.ClassEmitterTransformer;
...
public class FieldProviderTransformer extends ClassEmitterTransformer {
    ...
    private static final Type FIELD_PROVIDER =
      TypeUtils.parseType("com.github.drinkjava2.cglib3_2_0.transform.impl.FieldProvider");
    ...
    // TODO_ if this is used to enhance class files SWITCH_STYLE_TRIE should be used
