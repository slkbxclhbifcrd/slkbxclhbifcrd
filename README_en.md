...
<p align="center">
  The brand new Java persistence tool Java
</p>
...
[Chinese中文手册](https://gitee.com/drinkjava2/jSqlBox/wikis/%E7%AE%80%E4%BB%8B)  |  [English User Manual](../../wiki)  | [JavaDoc](http://search.maven.org/#search%7Cga%7C1%7Ca%3A%22jsqlbox%22)
...
<dependency>
   ...
   <artifactId>jsqlbox</artifactId> <!-- for Java6,7-->
...
<dependency>
   <groupId>com.github.drinkjava2</groupId>
   <artifactId>jsqlbox-java8</artifactId> <!-- for Java8 -->
   <version>2.0.0</version>
</dependency> 
```
